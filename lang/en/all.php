...
return [
    ...
    'message' => [
        ...
        'session_logout_success'           => 'Device logged out successfully.',
        'all_sessions_logout_success'      => 'All devices logged out successfully.',
        'other_sessions_logout_success'    => 'Other devices logged out successfully.',
        'cannot_revoke_current_session'    => 'Use logout to end your current session.',
        'fcm_token_not_found'              => 'Push notification device not found.',
        'fcm_token_revoke_success'         => 'Push device removed successfully.',
        'all_fcm_tokens_revoke_success'    => 'All push devices removed successfully.',
        'other_fcm_tokens_revoke_success'  => 'Other push devices removed successfully.',
        ...
        'swich_ip_not_whitelisted'         => 'Swich blocked JazzCash / EasyPaisa (code 0027: IP not whitelisted). Ask Swich to whitelist this server IP for E-Wallet. 1Bill can still work.',
        ...
        'agent_is_not_active'              => 'The agent is not active.'
    ]
];
