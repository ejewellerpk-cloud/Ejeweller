...
class SiteService
{
    ...
    public function update(SiteRequest $request)
    {
        try {
            ...
            $newKeys = ['site_facebook_pixel_id', 'site_facebook_capi_token', 'site_facebook_capi_status', 'site_homepage_theme', 'site_show_stock_out', 'site_abandoned_cart_reminder'];
