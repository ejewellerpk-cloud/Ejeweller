...
class Order extends Model
{
    ...
    {
        return $this->hasOne(OrderAddress::class)->where('address_type', \App\Enums\AddressType::SHIPPING);
    }
    ...
    public function orderCoupon(): \Illuminate\Database\Eloquent\Relations\HasOne
    {
