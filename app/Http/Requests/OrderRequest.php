...
class OrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'shipping_id'     => (int) request('order_type') == OrderType::DELIVERY && auth('sanctum')->check() ? ['required', 'numeric'] : ['nullable'],
            'billing_id'      => (int) request('order_type') == OrderType::DELIVERY && auth('sanctum')->check() ? ['required', 'numeric'] : ['nullable'],
