...
class ProductsReportController extends AdminController implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:products-report', only: ['index']),
            new Middleware('permission:products-report', only: ['export']),
            new Middleware('permission:products-report', only: ['productsReportOverview']),
            new Middleware('permission:products-report', only: ['exportPdf']),
        ];
    }
