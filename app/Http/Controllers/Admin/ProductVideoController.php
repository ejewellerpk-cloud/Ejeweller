...
class ProductVideoController extends AdminController implements HasMiddleware
{
    /**
    ...
    {
        return [
            new Middleware('permission:products_show', only: ['index']),
            new Middleware('permission:products_show', only: ['store']),
            new Middleware('permission:products_show', only: ['update']),
            new Middleware('permission:products_show', only: ['destroy']),
        ];
    }
