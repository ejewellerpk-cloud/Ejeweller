...
class CustomerController extends AdminController implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:customers|return-orders', only: ['index']),
            ...
            new Middleware('permission:customers_show', only: ['changePassword']),
            new Middleware('permission:customers_show', only: ['changeImage']),
            new Middleware('permission:customers_show', only: ['myOrder']),
        ];
    }
