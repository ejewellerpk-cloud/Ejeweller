...
class EmployeeController extends AdminController implements HasMiddleware
{
    ...
    public static function middleware(): array
    {
        return [
            ...
            new Middleware('permission:employees_show', only: ['changePassword']),
            new Middleware('permission:employees_show', only: ['changeImage']),
            new Middleware('permission:employees_show', only: ['myOrder']),
        ];
    }
