...
class PromotionProductController extends AdminController implements HasMiddleware
{
    ...
    {
        return [
            new Middleware('permission:promotions_show', only: ['index']),
            new Middleware('permission:promotions_show', only: ['store']),
            new Middleware('permission:promotions_show', only: ['destroy']),
        ];
    }
