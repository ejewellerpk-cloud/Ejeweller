                ...
                <li v-for="(cart, index) in carts"
                    ...
                    <div class="relative w-full overflow-hidden">
                        ...
                        <p v-if="shouldShowCartSocialProof(cart)"
                            class="text-red-500 font-bold text-[9px] sm:text-[10px] mt-1 flex flex-nowrap items-center gap-1 leading-none whitespace-nowrap overflow-hidden text-ellipsis max-w-full">
