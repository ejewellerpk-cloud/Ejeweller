<template>
    ...
    <div class="col-12">
        <div id="productSection" class="db-tab-div active">
            ...
            <div class="db-card tab-content" :class="{ active: activeTab === 'information' }" id="productSectionInformation">
            ...
            <div class="db-card tab-content" :class="{ active: activeTab === 'products' }" id="productSectionProduct">
                <ProductSectionProductListComponent v-if="activeTab === 'products'" :productSection="parseInt($route.params.id)" />
            </div>
        </div>
    </div>
</template>
