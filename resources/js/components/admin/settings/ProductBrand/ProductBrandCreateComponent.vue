                    ...
                    <div class="form-row">
                        ...
                        <div class="form-col-12">
                            <div class="modal-btns">
                                ...
                                <button type="submit" class="db-btn py-2 text-white bg-primary" :disabled="loading.isActive">
                                    <i v-if="loading.isActive" class="fa-solid fa-circle-notch animate-spin mr-1"></i>
                                    <i v-else class="lab lab-fill-save"></i>
                                    <span>{{ loading.isActive ? $t('label.uploading') : $t("button.save") }}</span>
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    methods: {
        ...
        async handleMediaSelected(asset) {
            try {
                ...
                this.$refs.imageProperty.value = null; // Clear manual file input
            } catch (error) {
