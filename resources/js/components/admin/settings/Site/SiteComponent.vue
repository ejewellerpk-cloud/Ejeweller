            ...
            <form @submit.prevent="save">
                <div class="form-row">
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <input v-on:keypress="onlyNumber($event)" v-model="form.site_digit_after_decimal_point"
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        <label class="db-field-title required" for="guest_checkout_enable">{{
                            $t("label.guest_checkout")
                            }}</label>
                        <div class="db-field-radio-group">
                            <div class="db-field-radio">
                                <div class="custom-radio">
                                    <input :value="enums.activityEnum.ENABLE" v-model="form.site_guest_checkout"
                                        id="guest_checkout_enable" type="radio" class="custom-radio-field" />
                                    <span class="custom-radio-span"></span>
                                </div>
                                <label for="guest_checkout_enable" class="db-field-label">
                                    {{ $t("label.enable") }}
                                </label>
                            </div>
                            <div class="db-field-radio">
                                <div class="custom-radio">
                                    <input :value="enums.activityEnum.DISABLE" v-model="form.site_guest_checkout"
                                        type="radio" id="guest_checkout_disable" class="custom-radio-field" />
                                    <span class="custom-radio-span"></span>
                                </div>
                                <label for="guest_checkout_disable" class="db-field-label">
                                    {{ $t("label.disable") }}
                                </label>
                            </div>
                        </div>
                        <small class="db-field-alert" v-if="errors.site_guest_checkout">
                            {{ errors.site_guest_checkout[0] }}
                        </small>
                    </div>
                    ...
                    <div class="form-col-12 sm:form-col-6">
                        ...
                        <div class="db-field-radio-group">
                            <div class="db-field-radio">
                                <div class="custom-radio">
                                    <input :value="enums.activityEnum.ENABLE" v-model="form.site_whatsapp_status"
                                        id="whatsapp_chat_icon_enable" type="radio" class="custom-radio-field" />
                                    <span class="custom-radio-span"></span>
                                </div>
                                <label for="whatsapp_chat_icon_enable" class="db-field-label">
                                    {{ $t("label.enable") }}
                                </label>
                            </div>
                            <div class="db-field-radio">
                                <div class="custom-radio">
                                    <input :value="enums.activityEnum.DISABLE" v-model="form.site_whatsapp_status"
                                        type="radio" id="whatsapp_chat_icon_disable" class="custom-radio-field" />
                                    <span class="custom-radio-span"></span>
                                </div>
                                <label for="whatsapp_chat_icon_disable" class="db-field-label">
                                    {{ $t("label.disable") }}
                                </label>
                            </div>
                        </div>
                        <small class="db-field-alert" v-if="errors.site_whatsapp_status">
                            {{ errors.site_whatsapp_status[0] }}
                        </small>
                    </div>

                    <div class="form-col-12 sm:form-col-6">
                        <label for="site_facebook_pixel_id" class="db-field-title">
                            Facebook Pixel ID
                        </label>
                        <input v-model="form.site_facebook_pixel_id" v-bind:class="errors.site_facebook_pixel_id ? 'invalid' : ''"
                            type="text" id="site_facebook_pixel_id" class="db-field-control" />
                        <small class="db-field-alert" v-if="errors.site_facebook_pixel_id">
                            {{ errors.site_facebook_pixel_id[0] }}
                        </small>
                    </div>
    ...
    methods: {
        ...
        load: async function () {
            try {
                ...
                await this.$store.dispatch('aiAgent/lists', {
                    order_column: 'id',
                    order_type: 'asc',
                    status: statusEnum.ACTIVE
                });
            ...
            try {
                ...
                this.$store.dispatch("site/save", this.form).then((res) => {
                    ...
                    if (err.response) {
                        ...
                        alertService.error("Network Error: Could not connect to server.");
                    }
                });
            } catch (err) {
                this.loading.isActive = false;
