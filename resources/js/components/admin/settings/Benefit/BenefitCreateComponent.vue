                ...
                <form @submit.prevent="save">
                    <div class="form-row">
                        ...
                        <div class="form-col-12 sm:form-col-12">
                            <label for="image" class="db-field-title required">{{ $t('label.image') }} (36px,36px)</label>
                            <div class="flex items-center gap-4 mb-3">
                                <img :src="imagePreview || '/images/default/no-image.png'" 
                                     class="w-12 h-12 object-contain rounded border border-slate-200 bg-slate-50 p-1" />
