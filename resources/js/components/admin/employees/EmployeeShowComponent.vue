<template>
    ...
    <div class="col-12" v-if="Object.entries(employee).length > 0">
        ...
        <div class="profile-tabDiv" :class="{ active: activeTab === 'sessions' }">
            <UserSessionsComponent v-if="activeTab === 'sessions'" :user-id="$route.params.id" api-prefix="employee" mode="admin" />
        </div>
        <div class="profile-tabDiv" :class="{ active: activeTab === 'push_devices' }">
            <UserFcmTokensComponent v-if="activeTab === 'push_devices'" :user-id="$route.params.id" api-prefix="employee" mode="admin" />
        </div>
