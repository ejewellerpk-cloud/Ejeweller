    ...
    actions: {
        lists: function (context, payload) {
            return new Promise((resolve, reject) => {
                const url = payload.mode === "self"
                    ? "auth/fcm-tokens"
                    : `admin/${payload.apiPrefix}/fcm-tokens/${payload.userId}`;
        ...
        allLists: function (context, payload) {
            return new Promise((resolve, reject) => {
                let url = `admin/${payload.apiPrefix}/fcm-tokens`;
                if (payload.search) {
        ...
        destroy: function (context, payload) {
            return new Promise((resolve, reject) => {
                const url = payload.mode === "self"
                    ? `auth/fcm-tokens/${payload.tokenId}`
                    : `admin/${payload.apiPrefix}/fcm-tokens/${payload.userId}/${payload.tokenId}`;
        ...
        destroyAll: function (context, payload) {
            return new Promise((resolve, reject) => {
                const url = payload.mode === "self"
                    ? (payload.othersOnly ? "auth/fcm-tokens/others" : "auth/fcm-tokens/all")
                    : `admin/${payload.apiPrefix}/fcm-tokens/${payload.userId}`;
        ...
        revokeCurrent: function (context, payload) {
            return axios.post("auth/fcm-tokens/revoke-current", payload);
        },
    },
    mutations: {
