    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="content">
                ...
                <p>Hello {{ $name }},</p>
                <p>We are writing to share an update regarding your order with us:</p>
                ...
                <p>You can track and manage your orders anytime by logging into your account dashboard.</p>
